...
app.controller('PrivacyCtrl', ['$scope', '$state', '$rootScope', '$ionicLoading', '$http', '$sce', function($scope, $state, $rootScope, $ionicLoading, $http, $sce) {

    console.log("Privacy ctrl");
    // $scope.config = {
    //     preload: "none",
    //     sources: [{ src: $sce.trustAsResourceUrl($rootScope.selectedArticle.video), type: "video/mp4" }],
    //     plugins: { poster: $rootScope.selectedArticle.video_thumbnail }
